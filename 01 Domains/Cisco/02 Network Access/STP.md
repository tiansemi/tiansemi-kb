...
> STP est un concept à documenter dans la base Cisco CCNA.
...
À la fin de cette note, l'apprenant doit pouvoir expliquer STP, identifier son rôle dans une communication réseau et reconnaître les erreurs fréquentes associées.
...
- Peux-tu expliquer STP avec un exemple simple ?
...
1. Quel est le rôle principal de STP ?
...
Q: Qu'est-ce que STP ?
A: STP est un concept à documenter dans la base Cisco CCNA.

---

## Labs

Créer un petit lab Packet Tracer avec deux hôtes, un switch et un routeur, puis vérifier le comportement associé à STP.
