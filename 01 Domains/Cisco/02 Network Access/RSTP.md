...
> RSTP est un concept à documenter dans la base Cisco CCNA.
...
À la fin de cette note, l'apprenant doit pouvoir expliquer RSTP, identifier son rôle dans une communication réseau et reconnaître les erreurs fréquentes associées.
...
- Peux-tu expliquer RSTP avec un exemple simple ?
...
1. Quel est le rôle principal de RSTP ?
...
Q: Qu'est-ce que RSTP ?
A: RSTP est un concept à documenter dans la base Cisco CCNA.

---

## Labs

Créer un petit lab Packet Tracer avec deux hôtes, un switch et un routeur, puis vérifier le comportement associé à RSTP.
