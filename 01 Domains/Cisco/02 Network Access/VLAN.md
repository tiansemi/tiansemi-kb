...
> Un VLAN segmente logiquement un switch en plusieurs domaines de broadcast indépendants.
...
À la fin de cette note, l'apprenant doit pouvoir expliquer VLAN, identifier son rôle dans une communication réseau et reconnaître les erreurs fréquentes associées.
...
- Peux-tu expliquer VLAN avec un exemple simple ?
...
1. Quel est le rôle principal de VLAN ?
...
Q: Qu'est-ce que VLAN ?
A: Un VLAN segmente logiquement un switch en plusieurs domaines de broadcast indépendants.

---

## Labs

Créer un petit lab Packet Tracer avec deux hôtes, un switch et un routeur, puis vérifier le comportement associé à VLAN.
