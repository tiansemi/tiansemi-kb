...
> ARP associe une adresse IPv4 à une adresse MAC pour permettre la livraison locale d'une trame Ethernet.
...
À la fin de cette note, l'apprenant doit pouvoir expliquer ARP, identifier son rôle dans une communication réseau et reconnaître les erreurs fréquentes associées.
...
- Peux-tu expliquer ARP avec un exemple simple ?
...
1. Quel est le rôle principal de ARP ?
...
Q: Qu'est-ce que ARP ?
A: ARP associe une adresse IPv4 à une adresse MAC pour permettre la livraison locale d'une trame Ethernet.

---

## Labs

Créer un petit lab Packet Tracer avec deux hôtes, un switch et un routeur, puis vérifier le comportement associé à ARP.
