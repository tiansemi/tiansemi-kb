...
> Le modèle TCP/IP organise les communications Internet autour des couches application, transport, internet et accès réseau.
...
À la fin de cette note, l'apprenant doit pouvoir expliquer TCP-IP Model, identifier son rôle dans une communication réseau et reconnaître les erreurs fréquentes associées.
...
- Peux-tu expliquer TCP-IP Model avec un exemple simple ?
...
1. Quel est le rôle principal de TCP-IP Model ?
...
Q: Qu'est-ce que TCP-IP Model ?
A: Le modèle TCP/IP organise les communications Internet autour des couches application, transport, internet et accès réseau.

---

## Labs

Créer un petit lab Packet Tracer avec deux hôtes, un switch et un routeur, puis vérifier le comportement associé à TCP-IP Model.
