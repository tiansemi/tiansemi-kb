...
> OSI Layer 3 - Network est un concept à documenter dans la base Cisco CCNA.
...
À la fin de cette note, l'apprenant doit pouvoir expliquer OSI Layer 3 - Network, identifier son rôle dans une communication réseau et reconnaître les erreurs fréquentes associées.
...
- Peux-tu expliquer OSI Layer 3 - Network avec un exemple simple ?
...
1. Quel est le rôle principal de OSI Layer 3 - Network ?
...
Q: Qu'est-ce que OSI Layer 3 - Network ?
A: OSI Layer 3 - Network est un concept à documenter dans la base Cisco CCNA.

---

## Labs

Créer un petit lab Packet Tracer avec deux hôtes, un switch et un routeur, puis vérifier le comportement associé à OSI Layer 3 - Network.
