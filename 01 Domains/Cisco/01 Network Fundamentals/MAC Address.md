...
> Une adresse MAC identifie une interface réseau au niveau liaison de données dans un réseau Ethernet.
...
À la fin de cette note, l'apprenant doit pouvoir expliquer MAC Address, identifier son rôle dans une communication réseau et reconnaître les erreurs fréquentes associées.
...
- Peux-tu expliquer MAC Address avec un exemple simple ?
...
1. Quel est le rôle principal de MAC Address ?
...
Q: Qu'est-ce que MAC Address ?
A: Une adresse MAC identifie une interface réseau au niveau liaison de données dans un réseau Ethernet.

---

## Labs

Créer un petit lab Packet Tracer avec deux hôtes, un switch et un routeur, puis vérifier le comportement associé à MAC Address.
