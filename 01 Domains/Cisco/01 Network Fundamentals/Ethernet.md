...
> Ethernet est la technologie dominante de réseau local câblé, responsable de la transmission de trames sur un lien LAN.
...
À la fin de cette note, l'apprenant doit pouvoir expliquer Ethernet, identifier son rôle dans une communication réseau et reconnaître les erreurs fréquentes associées.
...
- Peux-tu expliquer Ethernet avec un exemple simple ?
...
1. Quel est le rôle principal de Ethernet ?
...
Q: Qu'est-ce que Ethernet ?
A: Ethernet est la technologie dominante de réseau local câblé, responsable de la transmission de trames sur un lien LAN.

---

## Labs

Créer un petit lab Packet Tracer avec deux hôtes, un switch et un routeur, puis vérifier le comportement associé à Ethernet.
