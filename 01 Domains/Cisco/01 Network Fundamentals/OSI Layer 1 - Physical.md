...
> OSI Layer 1 - Physical est un concept à documenter dans la base Cisco CCNA.
...
À la fin de cette note, l'apprenant doit pouvoir expliquer OSI Layer 1 - Physical, identifier son rôle dans une communication réseau et reconnaître les erreurs fréquentes associées.
...
- Peux-tu expliquer OSI Layer 1 - Physical avec un exemple simple ?
...
1. Quel est le rôle principal de OSI Layer 1 - Physical ?
...
Q: Qu'est-ce que OSI Layer 1 - Physical ?
A: OSI Layer 1 - Physical est un concept à documenter dans la base Cisco CCNA.

---

## Labs

Créer un petit lab Packet Tracer avec deux hôtes, un switch et un routeur, puis vérifier le comportement associé à OSI Layer 1 - Physical.
