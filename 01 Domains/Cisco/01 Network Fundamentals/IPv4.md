...
> IPv4 fournit un adressage logique sur 32 bits et permet le routage des paquets entre réseaux.
...
À la fin de cette note, l'apprenant doit pouvoir expliquer IPv4, identifier son rôle dans une communication réseau et reconnaître les erreurs fréquentes associées.
...
- Peux-tu expliquer IPv4 avec un exemple simple ?
...
1. Quel est le rôle principal de IPv4 ?
...
Q: Qu'est-ce que IPv4 ?
A: IPv4 fournit un adressage logique sur 32 bits et permet le routage des paquets entre réseaux.

---

## Labs

Créer un petit lab Packet Tracer avec deux hôtes, un switch et un routeur, puis vérifier le comportement associé à IPv4.
