...
> Une PDU est l'unité de données manipulée par une couche réseau : données, segment, paquet, trame ou bits selon le contexte.
...
À la fin de cette note, l'apprenant doit pouvoir expliquer PDU, identifier son rôle dans une communication réseau et reconnaître les erreurs fréquentes associées.
...
- Peux-tu expliquer PDU avec un exemple simple ?
...
1. Quel est le rôle principal de PDU ?
...
Q: Qu'est-ce que PDU ?
A: Une PDU est l'unité de données manipulée par une couche réseau : données, segment, paquet, trame ou bits selon le contexte.

---

## Labs

Créer un petit lab Packet Tracer avec deux hôtes, un switch et un routeur, puis vérifier le comportement associé à PDU.
