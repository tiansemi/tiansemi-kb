...
> IPv6 fournit un adressage logique sur 128 bits, conçu pour remplacer progressivement IPv4 et simplifier certains mécanismes réseau.
...
À la fin de cette note, l'apprenant doit pouvoir expliquer IPv6, identifier son rôle dans une communication réseau et reconnaître les erreurs fréquentes associées.
...
- Peux-tu expliquer IPv6 avec un exemple simple ?
...
1. Quel est le rôle principal de IPv6 ?
...
Q: Qu'est-ce que IPv6 ?
A: IPv6 fournit un adressage logique sur 128 bits, conçu pour remplacer progressivement IPv4 et simplifier certains mécanismes réseau.

---

## Labs

Créer un petit lab Packet Tracer avec deux hôtes, un switch et un routeur, puis vérifier le comportement associé à IPv6.
