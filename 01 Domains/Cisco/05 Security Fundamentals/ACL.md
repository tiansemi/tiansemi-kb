...
> ACL est un concept à documenter dans la base Cisco CCNA.
...
À la fin de cette note, l'apprenant doit pouvoir expliquer ACL, identifier son rôle dans une communication réseau et reconnaître les erreurs fréquentes associées.
...
- Peux-tu expliquer ACL avec un exemple simple ?
...
1. Quel est le rôle principal de ACL ?
...
Q: Qu'est-ce que ACL ?
A: ACL est un concept à documenter dans la base Cisco CCNA.

---

## Labs

Créer un petit lab Packet Tracer avec deux hôtes, un switch et un routeur, puis vérifier le comportement associé à ACL.
